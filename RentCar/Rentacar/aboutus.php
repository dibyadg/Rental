...
<head>
    ...
    <title>About Us - Quick Rent</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black;background:#6C464F;">
        <div class="container">
    ...
    <section class="services">
        ...
        <div class="inner">
            ...
            <div class="inner-right">
                <h2>What We offer?</h2>
                <p>What quick rent services offers to customers?
...
<section class="footer">
    <div class="container">
        ...
        <div class="box">
            <h3>Contact Us</h3>
            <a href=""><i class="fa fa-phone-alt" aria-hidden="true"></i> +977 9840407309</a>
            <a href=""><i class="fa fa-phone-alt" aria-hidden="true"></i> +977 9803777920</a>
            <a href=""><i class="fa fa-envelope" aria-hidden="true"></i> inquiry@quickrent.com</a>
            <a href=""><i class="fa fa-map-location" aria-hidden="true"></i> Head Office - Maitidevi, Kathmandu</a>
