...
<!-- Navigation -->
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black;background:orange;">
        <div class="container">
...
?>
    ...
    <h3 class="text-center">Please use this esewa number for Payment - 9803777927</h3>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                <h5 ><a href="https://merchant.esewa.com.np/auth/login" target="_blank">Click here for payment</a></h5>
                <br>
            </div>
        </div>
